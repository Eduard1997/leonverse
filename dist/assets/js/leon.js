...
$(document).ready(function () {
  Slider.init();
  $('.leon-btn-whitepaper.disabled').hover(function () {
  ...
  $('.leon-btn-audit.disabled').hover(function () {
    $(this).find('span.text-content').text('Coming Soon');
  }, function () {
  ...
  $('.leon-lang-dropdown .dropbtn').on('click', function () {
  ...
  $('.leon-lang-dropdown .dropdown-content a').on('click', function (e) {
    e.preventDefault();
    var newFlagClass = $(this).data('flag');
    $('.leon-lang-dropdown .default-flag').attr('class', "".concat(newFlagClass, " default-flag"));
